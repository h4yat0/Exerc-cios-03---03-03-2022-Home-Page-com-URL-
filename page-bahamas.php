...
<html lang="pt-br">
  ...
  <body>
    <main>
      ...
      <h1 class="text-center">O que ver nas Bahamas</h1>
      <br><br><br>
        <div class="row g-5">
          <div class="col">
            <img src="./src/img/baha.jpg" class="img-fluid" style="max-width: 500px"/>
          ...
          <div class="col">
            ...
            <img src="./src/img/barcos.jpg" class="img-fluid" style='max-width: 500px'/>
          </div>
        </div>
