...
<html lang="pt-br">
  ...
  <body>
    <main>
      ...
      <h1 class="text-center">O que ver em Orlando</h1>
      <br><br><br>
        <div class="row g-5">
          <div class="col">
            <img src="./src/img/disney.jpg" class="img-fluid" style="max-width: 500px"/>
          ...
          <div class="col">
            ...
            <img src="./src/img/uni.jpg" class="img-fluid" style='max-width: 450px'/>
          </div>
        </div>
